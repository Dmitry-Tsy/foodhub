...
- **FoodHub-PRODUCTION-v1.3-STABLE.apk** - Последняя стабильная версия ✅
  - Версия: 1.3
  - Дата: 14 ноября 2025
  - API: https://foodhub-backend-96im.onrender.com
  - Все баги исправлены, добавление блюд работает!
...
|--------|-----|------|----------|
| **1.3** | **FoodHub-PRODUCTION-v1.3-STABLE.apk** | 14.11.2025 | **✅ STABLE - Google Places ID → UUID** |
