...
- **FoodHub-PRODUCTION-v1.1-BUGFIXES.apk** - Последняя стабильная версия
  - Версия: 1.1
  - Дата: 14 ноября 2025
...
|--------|-----|------|----------|
| 1.1 | FoodHub-PRODUCTION-v1.1-BUGFIXES.apk | 14.11.2025 | Bugfixes: логотип, краш профиля, auth persistence |
| 1.0 | FoodHub-PRODUCTION-v1.0.apk | 14.11.2025 | Первый production релиз |
