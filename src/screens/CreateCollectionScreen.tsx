...
const CreateCollectionScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Успешно', 'Коллекция создана!', [
        {
          text: 'OK',
      ...
      Alert.alert('Ошибка', error.message || 'Не удалось создать коллекцию');
    } finally {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Создать коллекцию</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
        ...
        <Button
          title={isSubmitting ? 'Создание...' : 'Создать коллекцию'}
